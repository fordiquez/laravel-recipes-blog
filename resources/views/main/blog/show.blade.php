                    ...
                    <div class="single-blog-box">
                        ...
                        <div class="blog-content">
                            <ul class="entry-meta">
                                ...
                                <li><a href="#"><i class="fas fa-comments"></i><span>3</span> comments</a></li>
                                <li><a href="#"><i class="fas fa-heart"></i><span>59</span> likes</a></li>
                            </ul>
                        ...
                        <div class="next-prev-post">
                            <div class="prev-post">
                                <a href="#" class="item-figure"><img src="{{ asset('assets/img/blog/prev-post.jpg') }}" alt="Post"></a>
                            ...
                            <div class="next-post">
                                ...
                                <a href="#" class="item-figure"><img src="{{ asset('assets/img/blog/next-post.jpg') }}" alt="Post"></a>
                            </div>
                        </div>
                        <div class="recipe-reviews">
                            ...
                            <ul>
                                <li class="reviews-single-item">
                                    <div class="media media-none--xs">
                                        <img src="{{ asset('assets/img/blog/comment1.jpg') }}" alt="Comment" class="media-img-auto">
                                        <div class="media-body">
                                ...
                                <li class="reviews-single-item">
                                    <div class="media media-none--xs">
                                        <img src="{{ asset('assets/img/blog/comment2.jpg') }}" alt="Comment" class="media-img-auto">
                                        <div class="media-body">
