                                                    ...
                                                    <div class="elementor-element elementor-widget">
                                                        <div class="elementor-widget-container">
                                                            <div class="adv-search-wrap">
                                                                <form class="advanced-search" action="{{ route('main.recipes.index') }}" method="get">
                                                                    <div class="input-group">
                                                                        <input type="text" name="title" class="form-control" placeholder="Search recipe by title" value="{{ request()->query('title') }}">
                                                                        <div class="btn-group">
                                                                            <div class="input-group-btn">
                                                                                <button type="button" id="rt-adv-search" class="btn-adv-search">
                                                                                    ...
                                                                                    @foreach($categories as $category)
                                                                                        <li>
                                                                                            <div class="checkbox checkbox-primary">
                                                                                                ...
                                                                                                <label for="category-{{ $category->id }}" style="cursor: pointer" class="user-select-none">
                                                                                                    {{ $category->title }}
                                                                                                </label>
                                                                                            </div>
                                                                                        </li>
                                                                                    ...
                                                                                    @foreach($cuisines as $cuisine)
                                                                                        <li>
                                                                                            <div class="checkbox checkbox-primary">
                                                                                                ...
                                                                                                <label for="cuisine-{{ $cuisine->id }}" style="cursor: pointer" class="user-select-none">
                                                                                                    {{ $cuisine->title }}
                                                                                                </label>
                                                                                            </div>
                                                                                        </li>
                                                                                    ...
                                                                                    @foreach($tags as $tag)
                                                                                        <li>
                                                                                            <div class="checkbox checkbox-primary">
                                                                                                ...
                                                                                                <label for="tag-{{ $tag->id }}" style="cursor: pointer" class="user-select-none">
                                                                                                    {{ $tag->title }}
                                                                                                </label>
                                                                                            </div>
                                                                                        </li>
                                                                                    ...
                                                                                    @foreach($levels as $key => $level)
                                                                                        <li>
                                                                                            <div class="checkbox checkbox-primary">
                                                                                                ...
                                                                                                <label for="{{ $key }}" style="cursor: pointer" class="user-select-none">
                                                                                                    {{ $level }}
                                                                                                </label>
                                                                                            </div>
                                                                                        </li>
