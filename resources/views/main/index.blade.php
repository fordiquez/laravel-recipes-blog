                ...
                <div class="col-lg-4 d-block d-md-none d-lg-block col-sm-12">
                    <div class="product-box-layout1">
                        ...
                        <div class="item-content">
                            ...
                            <h3 class="item-title"><a href="single-recipe1.html">Blueberry Juice with Lemon
                                    Crema</a></h3>
                            <ul class="item-rating">
                                <li class="star-fill"><i class="fas fa-star"></i></li>
                                <li class="star-fill"><i class="fas fa-star"></i></li>
            ...
            <div class="row gutters-60">
                <div class="col-lg-8">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="product-box-layout1">
                                ...
                                <div class="item-content">
                                    ...
                                    <ul class="entry-meta">
                                        <li><a href="#"><i class="fas fa-clock"></i>15 Mins</a></li>
                                        <li><a href="#"><i class="fas fa-user"></i>by <span>John Martin</span></a>
                                        </li>
                                        <li><a href="#"><i class="fas fa-heart"></i><span>02</span> Likes</a></li>
                                    </ul>
                                </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-12">
                            <div class="product-box-layout1">
                                ...
                                <div class="item-content">
                                    ...
                                    <h3 class="item-title"><a href="single-recipe1.html">Asian Chicken Noodles</a>
                                    </h3>
                                    <ul class="item-rating">
                                        <li class="star-fill"><i class="fas fa-star"></i></li>
                                        <li class="star-fill"><i class="fas fa-star"></i></li>
                        ...
                        <div class="col-md-6 col-sm-6 col-12">
                            <div class="product-box-layout1">
                                ...
                                <div class="item-content">
                                    <span class="sub-title">SALAD</span>
                                    <h3 class="item-title"><a href="single-recipe1.html">Italiano Salad Mixed</a>
                                    </h3>
                                    <ul class="item-rating">
                                        <li class="star-fill"><i class="fas fa-star"></i></li>
                                        <li class="star-fill"><i class="fas fa-star"></i></li>
                        ...
                        <div class="col-md-6 col-sm-6 col-12">
                            <div class="product-box-layout1">
                                <figure class="item-figure"><a href="single-recipe1.html"><img
                                            src="{{ asset('assets/img/product/product7.jpg') }}"
                                            alt="Product"></a></figure>
                                <div class="item-content">
                        ...
                        <div class="col-md-6 col-sm-6 col-12">
                            <div class="product-box-layout1">
                                ...
                                <div class="item-content">
                                    <span class="sub-title">JUICE</span>
                                    <h3 class="item-title"><a href="single-recipe1.html">Soypan Fruits Juice</a>
                                    </h3>
                                    <ul class="item-rating">
                                        <li class="star-fill"><i class="fas fa-star"></i></li>
                                        <li class="star-fill"><i class="fas fa-star"></i></li>
                        ...
                        <div class="col-md-6 col-sm-6 col-12">
                            <div class="product-box-layout1">
                                <figure class="item-figure"><a href="single-recipe1.html"><img
                                            src="{{ asset('assets/img/product/product9.jpg') }}"
                                            alt="Product"></a></figure>
                                <div class="item-content">
                                    <span class="sub-title">BREAKFAST</span>
                        ...
                        <div class="col-md-6 col-sm-6 col-12">
                            <div class="product-box-layout1">
                                <figure class="item-figure"><a href="single-recipe1.html"><img
                                            src="{{ asset('assets/img/product/product10.jpg') }}"
                                            alt="Product"></a></figure>
                                <div class="item-content">
                                    <span class="sub-title">DINNER</span>
                                    <h3 class="item-title"><a href="single-recipe1.html">Asian Chicken Noodles</a>
                    ...
                    <div class="ranna-ad-box">
                        <a href="#"><img src="{{ asset('assets/img/figure/figure1.jpg') }}" alt="ad"></a>
                    </div>
                </div>
                <div class="col-lg-4 sidebar-widget-area sidebar-break-md">
                    <div class="widget">
                        ...
                        <div class="widget-about">
                            <figure class="author-figure"><img src="{{ asset('assets/img/figure/about.jpg') }}"
                                                               alt="about"></figure>
                            <figure class="author-signature"><img src="{{ asset('assets/img/figure/signature.png') }}"
                                                                  alt="about">
                            </figure>
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-follow-us">
                            <ul>
                                <li class="single-item"><a href="#"><i class="fab fa-facebook-f"></i>LIKE ME ON</a>
                                </li>
                                <li class="single-item"><a href="#"><i class="fab fa-twitter"></i>LIKE ME</a></li>
                                <li class="single-item"><a href="#"><i class="fab fa-linkedin-in"></i>LIKE ME</a>
                                </li>
                                <li class="single-item"><a href="#"><i class="fab fa-pinterest-p"></i>LIKE ME</a>
                                </li>
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-latest">
                            <ul class="block-list">
                                ...
                                <li class="single-item">
                                    <div class="item-img">
                                        <a href="#"><img src="{{ asset('assets/img/product/latest2.jpg') }}" alt="Post"></a>
                                ...
                                <li class="single-item">
                                    <div class="item-img">
                                        <a href="#"><img src="{{ asset('assets/img/product/latest3.jpg') }}" alt="Post"></a>
                                ...
                                <li class="single-item">
                                    <div class="item-img">
                                        <a href="#"><img src="{{ asset('assets/img/product/latest4.jpg') }}" alt="Post"></a>
                    ...
                    <div class="widget">
                        <div class="widget-ad">
                            <a href="#"><img src="{{ asset('assets/img/figure/figure2.jpg') }}" alt="Ad"
                                             class="img-fluid"></a>
                        </div>
                    </div>
                    <div class="widget">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="product-box-layout2">
                        <figure class="item-figure"><a href="single-recipe1.html"><img
                                    src="{{ asset('assets/img/product/product11.jpg') }}"
                                    alt="Product"></a></figure>
                        <div class="item-content">
                            <span class="sub-title">BREAKFAST</span>
                            <h3 class="item-title"><a href="single-recipe1.html">Tomatoes Stuffed with Foie and
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="product-box-layout2">
                        <figure class="item-figure"><a href="single-recipe1.html"><img
                                    src="{{ asset('assets/img/product/product12.jpg') }}"
                                    alt="Product"></a></figure>
                        <div class="item-content">
                            <span class="sub-title">DESERT</span>
                            <h3 class="item-title"><a href="single-recipe1.html">Pumpkin Cheesecake With
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="product-box-layout3">
                                <figure class="item-figure"><a href="single-recipe1.html"><img
                                            src="{{ asset('assets/img/product/product16.jpg') }}"
                                            alt="Product"></a></figure>
                                <div class="item-content">
                                    <span class="sub-title">SALAD</span>
                                    <h3 class="item-title"><a href="single-recipe1.html">Maxican Dessert</a></h3>
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-featured-feed">
                            <div class="rc-carousel nav-control-layout1" data-loop="true" data-items="3"
                                 data-margin="5" data-autoplay="true" data-autoplay-timeout="5000"
                                ...
                                <div class="featured-box-layout1">
                                    <div class="item-img">
                                        <img src="{{ asset('assets/img/product/product17.jpg') }}" alt="Brand"
                                             class="img-fluid">
                                    </div>
                                    <div class="item-content">
                                        <span class="ctg-name">BREAKFAST</span>
                                        <h4 class="item-title"><a href="single-recipe1.html">Baked Garlic Prawn</a>
                                        </h4>
                                ...
                                <div class="featured-box-layout1">
                                    <div class="item-img">
                                        <img src="{{ asset('assets/img/product/product18.jpg') }}" alt="Brand"
                                             class="img-fluid">
                                    </div>
                                    <div class="item-content">
                                ...
                                <div class="featured-box-layout1">
                                    <div class="item-img">
                                        <img src="{{ asset('assets/img/product/product19.jpg') }}" alt="Brand"
                                             class="img-fluid">
                                    </div>
                                    <div class="item-content">
